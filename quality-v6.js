...
(() => {
  ...
  const PRESETS={
    ...
    medium:{id:'medium',maxCrowd:340,maxParticles:115,dpr:2.75,maxDimension:2560,maxPixels:3500000,trailRate:.82,environmentDensity:.86,environmentShadows:true,characterDetail:132,propDetail:.86,weatherDensity:.80,finishCrowd:15},
    low:{id:'low',maxCrowd:250,maxParticles:75,dpr:2.5,maxDimension:2304,maxPixels:2800000,trailRate:.58,environmentDensity:.62,environmentShadows:false,characterDetail:88,propDetail:.68,weatherDensity:.56,finishCrowd:10}
  };
  function initial(){
