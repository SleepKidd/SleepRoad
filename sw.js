'use strict';
const CACHE='sleep-road-v16';
const ASSETS=['./','./index.html','./style.css','./animation-v5.css','./polish-v6.css','./menu-v7.css','./engine.js','./assets/models/countmaster-character.js','./systems-v4.js','./level-director-v5.js','./gameplay-v4.js','./level-runtime-v5.js','./render-v4.js','./render-levels-v5.js','./animation-v5.js','./progression-v6.js','./audio-v6.js','./quality-v6.js','./polish-v6.js','./menu-v7.js','./boot-v4.js','./icon.svg','./manifest.webmanifest'];
