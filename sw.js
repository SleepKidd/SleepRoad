'use strict';
const CACHE='sleep-road-v28';
const ASSETS=['./','./index.html','./style.css','./animation-v5.css','./polish-v6.css','./menu-v7.css','./environment-v8.css','./visual-v9.css','./experience-v11.css','./engine.js','./assets/models/countmaster-character.js','./systems-v4.js','./level-director-v5.js','./gameplay-v4.js','./level-runtime-v5.js','./render-v4.js','./render-levels-v5.js','./animation-v5.js','./progression-v6.js','./audio-v6.js','./quality-v6.js','./polish-v6.js','./menu-v7.js','./environment-v8.js','./visual-v9.js','./experience-v11.js','./boot-v4.js','./icon.svg','./manifest.webmanifest'];
