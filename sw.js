'use strict';
const CACHE='sleep-road-v11';
const ASSETS=['./','./index.html','./style.css','./engine.js','./systems-v4.js','./gameplay-v4.js','./render-v4.js','./boot-v4.js','./icon.svg','./manifest.webmanifest'];
