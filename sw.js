'use strict';
const CACHE='sleep-road-v12';
const ASSETS=['./','./index.html','./style.css','./engine.js','./assets/models/countmaster-character.js','./systems-v4.js','./gameplay-v4.js','./render-v4.js','./boot-v4.js','./icon.svg','./manifest.webmanifest'];
