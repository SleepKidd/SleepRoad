...
(() => {
  ...
  const BIOMES=[
    ...
    },
    {
      ...
      obstaclePool:['mines','saw','pusher','spikes','barrier','hammer','roller'],decor:'desert',lightDir:[-.35,.95,.22]
    },
    {
      ...
      obstaclePool:['crusher','hammer','saw','roller','pusher','barrier','movingWall','fallingBlock'],decor:'factory',lightDir:[-.55,.8,.30]
    },
    {
      ...
      obstaclePool:['laser','pendulum','movingWall','fireline','roller','crusher','pusher','saw'],decor:'city',lightDir:[-.30,.78,.55]
    },
    {
      ...
      obstaclePool:['laser','fireline','movingWall','fallingBlock','crusher','pendulum','hammer','roller','saw'],decor:'neon',lightDir:[-.20,.72,.65]
    }
  ];
